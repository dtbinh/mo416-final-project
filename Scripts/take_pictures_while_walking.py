...
from manage_joints import get_first_handles,JointControl,JointControlWhileTakingPictures
...
#print('Enter the folder to store images to')
naoDirectory = ''
...
#postureProxy.goToPosture(posture)
...
JointControlWhileTakingPictures(clientID,motionProxy,0,Body,naoDirectory,'NAO_vision1')
